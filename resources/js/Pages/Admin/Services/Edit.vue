...
const imagePreview = ref(props.service.image ? `/storage/${props.service.image}` : null);
const imageInput = ref(null);

const breadcrumbs = ref([
    { 'value': 'Home', 'route': route('admin:dashboard') },
    { 'value': 'Services', 'route': route('admin:services.index') },
    { 'value': 'Edit Service', 'route': '' },
]);
...
function removeImage() {
    form.image = null;
    imagePreview.value = props.service.image ? `/storage/${props.service.image}` : null;
    if (imageInput.value) {
