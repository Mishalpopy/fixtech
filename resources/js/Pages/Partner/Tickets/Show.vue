...
const breadcrumbs = ref([
    ...
    { 'value': 'My Assigned Complaints', 'route': route('partner:tickets.index') },
...
const downloadAttachment = (attachment) => {
    window.open(route('partner:tickets.attachments.download', {
    ...
    <AppLayout>
        ...
        <div class="mt-4 mx-6 space-y-6">
            ...
            <div class="flex justify-start">
                <Link :href="route('partner:tickets.index')">
                    <Button 
        ...
        >
            <form @submit.prevent="updateStatus" class="space-y-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Partner Notes</label>
                    <Textarea
                        v-model="statusForm.partner_notes"
                        rows="3"
                        placeholder="Add notes about this status change or work performed..."
                        class="w-full"
                        :class="{ 'p-invalid': statusForm.errors.partner_notes }"
                    />
                    <small v-if="statusForm.errors.partner_notes" class="p-error">{{ statusForm.errors.partner_notes }}</small>
