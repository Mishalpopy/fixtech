    ...
    <div
        ...
        <div class="flex flex-col items-center justify-center ">
            <div
                ...
                <div class="sm:max-w-md w-29rem bg-white bg-surface-0 dark:bg-surface-900 py-20 px-5 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-4">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Partner Portal</div>
                        <span class="text-muted-color font-medium">Sign in to continue</span>
                    </div>

                    <div v-if="status" class="bg-green-100 text-green-700 p-3 rounded mb-4">
                        {{ status }}
                    </div>
                    ...
                    <div>
                        ...
                        <label for="password1"
                            class="block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2 mt-4">Password</label>
                        ...
                        <div class="text-center mt-4">
                            ...
                            <Link :href="route('partner:register')" class="font-medium no-underline cursor-pointer text-primary">
                                Register here
                            </Link>
                        </div>
                    </div>
