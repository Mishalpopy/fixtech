...
const form = useForm({
    name: '',
    role: props.roles.find(el => el.id == props.invited_user.role_id).id,
    token: props.token,
    email: props.email,
    password: '',
...
const submit = () => {
    form.post(route('submit_invitation_password'), {
...
<template>
    ...
    <Head title="Initation Set Password" />
    ...
    <div class="bg-surface-50 dark:bg-surface-950 flex items-center justify-center min-h-screen overflow-hidden">
        <div class="flex flex-col items-center justify-center ">
            <div
                ...
                <div class="sm:max-w-md w-29rem bg-white bg-surface-0 dark:bg-surface-900 py-20 px-5 sm:px-20"
                    ...
                    <div class="text-center mb-4">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Welcome to
                            PrimeLand!</div>
                        <span class="text-muted-color font-medium">You'r Invited , as <div
                                class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">{{
                                    props.roles.find(el => el.id == props.invited_user.role_id).name}}</div> Please Set
                            Your Password and Continue</span>
                    </div>
                    ...
                    <div>
                        <div class="mt-4">
                            ...
                            <InputText id="name" type="text" class="mt-1 block w-full" v-model="form.name" required
                        ...
                        <div class="mt-4">
                            ...
                            <InputText id="email" type="email" class="mt-1 block w-full" v-model="form.email" required
                                readonly="true" autofocus autocomplete="username" />
                        ...
                        <div class="mt-4">
                            ...
                            <InputText id="password" type="password" class="mt-1 block w-full" v-model="form.password"
