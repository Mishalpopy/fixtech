                ...
                <div class="sm:max-w-md w-29rem bg-white bg-surface-0 dark:bg-surface-900 py-20 px-5 sm:px-20"
                    ...
                    <div>
                        <div>
                            ...
                            <InputText id="email" type="email" class="mt-1 block w-full" v-model="form.email" required readonly="true"
                        ...
                        <div class="mt-4 flex items-center justify-end">
                            <Button :class="{ 'opacity-25': form.processing }" :disabled="form.processing" @click="submit">
                                Reset Password
                            </Button>
                        </div>
                    </div>
