...
function logoutCustomer() {
    axios.post(route('customer:logout', {}))
        .then((res) => {
            router.get(route('customer:login'))
        })
        .catch(err => {
...
<template>
    ...
    <ul class="layout-menu flex flex-col justify-between" id="bottom_menu">
        ...
        <div class="mb-2 bottom-item">
            <div class="ml-6 mb-2">
                <div class="font-extrabold text-lg">{{ page.props?.customer?.name }}</div>
                <div style="line-height: 0.7rem;">{{ page.props?.customer?.email }}</div>
            ...
            <Menu ref="menu" id="overlay_menu" class="settings-menu" :model="setting_items" :popup="true">
                <template #item="{ item, props }">
                    <div class="p-1 cursor-pointer" @click="item.label == 'Logout' ? logoutCustomer() : null">
